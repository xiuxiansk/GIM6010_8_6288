...
void Vofa_Packet(void)
{
    ...
    vofa_send_data(7, motor_data.components.encoder->vel_estimate);
    vofa_send_data(8, motor_data.components.encoder->pos_estimate);
    vofa_send_data(9, motor_data.components.encoder->phase);
    vofa_send_data(10, motor_data.components.current->Temp_Result);
    vofa_send_data(11, motor_data.components.foc->vbus_filt);
